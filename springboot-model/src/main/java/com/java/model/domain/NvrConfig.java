...
public class NvrConfig {
    ...
    /**
     * nvr类型，1：存储服务器，2:NVR设备
     */
    @ApiModelProperty(value="nvr类型，1：存储服务器，2:NVR设备")
    ...
    private String nvrChannelNumStr;
    ...
    public void setNvrType(Integer nvrType) {
        this.nvrType = nvrType;
    }

    public String getNvrChannelNumStr() {
        return nvrChannelNumStr;
    }

    public void setNvrChannelNumStr(String nvrChannelNumStr) {
        this.nvrChannelNumStr = nvrChannelNumStr;
    }
