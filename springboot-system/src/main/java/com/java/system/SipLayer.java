...
public class SipLayer implements SipListener {
    ...
    /** Here we initialize the SIP stack.在这里，我们初始化SIP堆栈。 */
...
// suppose UDP is used as transport, Bob Cheng, 03-11-10
    ...
    /**
     * This method uses the SIP stack to send a message.此方法使用SIP堆栈发送消息。
     */
    ...
    /** This method is called by the SIP stack when a response arrives.当响应到达时，SIP堆栈将调用此方法。 */
...
//            messageProcessor.processInfo("--Sent");
    ...
    /**
     * This method is called by the SIP stack when a new request arrives.当新请求到达时，SIP堆栈将调用此方法
     */
     ...
     * 当消息没有应答时，SIP堆栈将调用此方法。注意，这与错误消息处理方式不同。
     */
